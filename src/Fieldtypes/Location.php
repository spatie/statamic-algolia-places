...
namespace Spatie\StatamicAlgoliaPlaces\Fieldtypes;
    ...
    protected function configFieldItems(): array
    {
        return [
            ...
            'language' => [
                'type' => 'text',
                'display' => __('Language'),
                'instructions' => __('Change the default language of the results. You can pass two letters language codes (ISO 639-1).'),
